...
library(data.table)
# 
# significantFitness <- fread('significant_genes_20220316.csv')
# 
...
# 
# write.csv(COGtable, 'significantCOGfitness_20220316.csv')
# 
# metabolism <- fread('significant_genes_grouped_Metabolism_20220107.csv')

metabolism <- fread('significant_genes_grouped_Metabolism_filtered_20220413.csv')
...
#pdf('metabolic_FoldDifferences_20220413.pdf', useDingbats=FALSE)
