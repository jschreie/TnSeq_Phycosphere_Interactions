...
vibFitness <- fread('Data/vibAloneFitness_20220621.csv', header=TRUE)
mariFitness <- fread('Data/mariAloneFitness_20220621.csv', header=TRUE)
...
meanFitness$Vib_fold_diff <- round(log2((meanFitness$meanW_vib+0.01)/(meanFitness$meanW_rpomAlone+0.01)),3)

meanFitness$Mari_fold_diff <- round(log2((meanFitness$meanW_mari+0.01)/(meanFitness$meanW_rpomAlone+0.01)),3)

meanFitness$CC_fold_diff <- round(log2((meanFitness$meanW_CC+0.01)/(meanFitness$meanW_rpomAlone+0.01)), 3)
