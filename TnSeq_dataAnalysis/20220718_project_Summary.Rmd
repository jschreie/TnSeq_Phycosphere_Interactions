...
significantFitness <- fread('Data/significantFitness_Metabolism_20220706.csv', header=TRUE)
table1 <- fread('Table1_20220718.csv', header=TRUE) %>% 
...
#pdf('fitnessOverview20220718.pdf', height=3, width=9,useDingbats=FALSE)
par(mfrow=c(1,4), mar=c(5,4,4,1))
...
#pdf('Asparagine.pdf')
plot(Time[rpomAsparagine], mean_OD[rpomAsparagine], type='n',  las=1, xlab='Time(h)', ylab='OD600', main='Asparagine', bty='n', ylim=c(0, 0.2),xlim=c(0, 50), cex=1.5, col='gray80')
