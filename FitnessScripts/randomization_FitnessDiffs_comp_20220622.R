...
randomizedDifferenceInMeans <- function(rpomAlone_W=rpomAlone_W_test, treatment_W=treatment_W_test) {
  #length of the two fitness measures (should be 4, NAs get removed at the time of the mean)
  ...
  # take the log2 fold change and then return this value
...
write.csv(fitnessSig_final, 'Data/comp_W_rando_20220701.csv', row.names=FALSE)
